<aside
    ...
    <div class="h-16 flex items-center px-6 border-b border-gray-100 dark:border-gray-700">
        <a href="{{ route('dashboard') }}" class="flex items-center gap-2">
            <img src="{{ asset('img/101_logo.png') }}" alt="Logo" class="w-10 h-10 object-contain">
            <span
                class="text-lg font-bold text-gray-900 dark:text-gray-100 text-wrap leading-tight">{{ config('app.name') }}</span>
        </a>
    </div>
