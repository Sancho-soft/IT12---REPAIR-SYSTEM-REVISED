<x-guest-layout>
    ...
    <div class="text-center mb-8">
        <a href="/">
            <x-application-logo class="w-auto h-24 mx-auto object-contain" />
        </a>
        <h2 class="text-lg font-bold text-gray-900 leading-tight">{{ config('app.name') }}</h2>
        ...
        <div>
            ...
            <div class="relative rounded-md shadow-sm">
                ...
                <input id="password" type="password" name="password" required autocomplete="current-password"
                    class="block w-full pl-10 pr-10 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm placeholder-gray-400"
                    placeholder="Enter your password">
                <div class="absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer">
                    <svg class="h-5 w-5 text-gray-400 hover:text-gray-500" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
